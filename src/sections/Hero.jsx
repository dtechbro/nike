  ...
  return (
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-5 text-4xl md:mt-10 md:text-5xl lg:text-6xl xl:text-8xl font-palanquin font-bold leading-tight max-sm:text-[24px] max-sm:leading-[32px]">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-3 md:pr-10">The New Arrival</span> <br />
          <span className="text-coral-red inline-block mt-2 md:mt-3">Nike</span> Shoes
        </h1>
